...
import com.wxn.bookread.data.model.config.ConfigColumnCount
import com.wxn.bookread.data.model.config.ConfigFontFamily
import com.wxn.bookread.data.model.config.ConfigImageFilter
import com.wxn.bookread.data.model.config.ConfigLanguage
import com.wxn.bookread.data.model.config.ConfigReadingProgression
import com.wxn.bookread.data.model.config.ConfigSpread
import com.wxn.bookread.data.model.config.ConfigTheme
import com.wxn.bookread.data.model.config.Configurable
 ...
 */
@Serializable
public data class EpubPreferences constructor(
    ...
    val language: ConfigLanguage? = null,
    ...
    val readingProgression: ConfigReadingProgression? = null,
    val scroll: Boolean? = null,
    val spread: ConfigSpread? = null,
    ...
    init {
        ...
        require(spread in listOf(null, ConfigSpread.NEVER, ConfigSpread.ALWAYS))
    ...
    public companion object {
        ...
        public fun fromLegacyEpubSettings(
            ...
            val colCount = sp
                ...
                ?.let {
                    when (it) {
                        0 -> ConfigColumnCount.AUTO
                        1 -> ConfigColumnCount.ONE
                        2 -> ConfigColumnCount.TWO
                        else -> null
                    }
                }
