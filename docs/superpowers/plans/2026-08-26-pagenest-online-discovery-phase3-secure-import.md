...
- [x] Commit/push checkpoint and prove local HEAD equals `origin/master`.
- [x] Tag `pagenest-v1.11.260826`, wait for GitHub Actions, and verify downloaded Release APK against `SHA256SUMS.txt` and package metadata.
