...
bool meta_setpid_opt = false;
bool meta_setserial_opt = false;
#endif

/* options values */
#ifdef USE_ENCRYPTION
char *meta_pid = NULL;
char *meta_serial = NULL;
#endif
/**
...
//
//#ifdef USE_ENCRYPTION
//    if (meta_setpid_opt || meta_setserial_opt) {
//        int ret = set_decryption_key(m, meta_serial, meta_pid);
//        if (ret != SUCCESS) {
//            mobi_free(m);
//            return ret;
//        }
